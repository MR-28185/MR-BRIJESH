...
OWNER_ID = 7832907389 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [6344648593]

# ✅ Multiple AUTH CHANNELS allowed
AUTH_CHANNELS = [-1002809085861]  # Add more channel IDs here
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳𝐌𝐑 𝐁𝐑𝐈𝐉𝐄𝐒𝐇 🇮🇳" ,url=f"https://t.me/Oye_brijesh") ],
                    [
                    InlineKeyboardButton("🔔 CHENNAL 🔔" ,url="https://t.me/+qutXY5xbN0I4OWY1") ],
                    [
